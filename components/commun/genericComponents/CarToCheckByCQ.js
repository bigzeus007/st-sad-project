        ...
        <div>
          ...
          {express && (
            <>
              ...
              <span className="">{props.workDone.express}</span>
              <br />
            </>
          )}
          {diagnostic && (
            <>
              ...
              <span className="">{props.workDone.diagnostic}</span>
              <br />
            </>
          )}
          {carrosserie && (
            <>
              ...
              <span className="">{props.workDone.carrosserie}</span>
              <br />
            </>
          )}
          {mecanique && (
            <>
              ...
              <span className="">{props.workDone.mecanique}</span>
              <br />
            </>
          )}
